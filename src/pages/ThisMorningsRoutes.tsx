...
function FilterBar({ filters, onFilterChange }: FilterBarProps) {
  return (
    <div className="bg-white border-[3px] border-gray-600 rounded-lg p-4 mb-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-3 text-sm">
        ...
        <div>
          ...
          <input
            ...
            className="w-full px-2 py-1.5 border border-gray-400 rounded text-sm focus:outline-none focus:ring-2 focus:ring-purple-500"
          />
        </div>
